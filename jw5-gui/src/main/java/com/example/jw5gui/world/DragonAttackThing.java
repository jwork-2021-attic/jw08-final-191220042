...
public class DragonAttackThing extends AttackThing {

    int attackValue=50;
    Direction dir;

    public DragonAttackThing(String url, World world, GridPane pane, int x, int y, Direction dir,PlayerAI owner) {
